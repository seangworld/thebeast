...
import { runDigitalStaffRuntime, type ConversationState, type RuntimeMessage } from "@/lib/digitalStaffRuntime";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({ error: error instanceof Error ? error.message : "The Director could not respond safely." }, { status: 502 });
  }
