...
export default function LoginPage() {
  ...
  const guidePromises = [
    ...
    "You can tell your Guide your goal in plain words.",
    "When it is time to learn, your Guide brings in the Tutor.",
  ];
      ...
      <div className="grid w-full max-w-5xl gap-5 lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch">
        <section className="beast-card flex flex-col justify-between">
          <div>
            ...
            />
            <p className="beast-kicker">BeastLearning Guide - The Beast {APP_VERSION}</p>
            <h1 className="beast-title">Meet Your BeastLearning Guide</h1>
          ...
          <div className="mt-6 rounded-2xl border border-indigo-300/35 bg-indigo-300/10 p-4">
            <p className="text-sm font-semibold leading-6 text-indigo-100">
              {"Hi. I'm your Guide. Tell me what you want your future to look like, and I will help you build the path one step at a time."}
            </p>
          </div>

          <div className="mt-5 grid gap-3">
            {guidePromises.map((promise) => (
              <div
                key={promise}
        ...
        <section className="beast-card flex flex-col justify-center">
          ...
          <p className="mt-5 text-xs leading-5 text-[#7f8da3]">
            Your Guide will meet you inside and help you decide what to do next.
          </p>
        </section>
      </div>
    </main>
