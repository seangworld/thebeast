...
export default function EducationCareerWorkspace({
  ...
  focus?: "education-planning" | "career-planning";
}) {
  ...
  return (
    <div className="grid min-w-0 gap-6" data-education-career-intelligence="BE-201">
      ...
      <section id="profile" className={`${focus ? "hidden" : ""} rounded-2xl border border-white/10 bg-[#111827] p-4 sm:p-6`} aria-labelledby="education-profile-heading">
      ...
      <section id="paths" className={`${focus === "education-planning" ? "hidden" : ""} rounded-2xl border border-white/10 bg-[#111827] p-4 sm:p-6`} aria-labelledby="paths-heading">
      ...
      <section id="roadmap" className={`${focus === "career-planning" ? "hidden" : ""} rounded-2xl border border-white/10 bg-[#111827] p-4 sm:p-6`} aria-labelledby="roadmap-heading">
      ...
      <section id="outcomes" className={`${focus ? "hidden" : ""} rounded-2xl border border-white/10 bg-[#111827] p-4 sm:p-6`} aria-labelledby="outcomes-heading"><p className="text-xs font-black uppercase tracking-[0.15em] text-emerald-200">Decision &amp; Outcome History</p><h2 id="outcomes-heading" className="mt-2 text-2xl font-black text-white">Learn from what happened without rewriting history</h2>
      ...
      <section className="grid gap-3 sm:grid-cols-3" aria-label="Shared BeastOS planning services"><Link className="rounded-xl border border-white/10 bg-white/[0.035] p-4 font-black text-white" href="/dashboard/education/goals">Education Goals <span aria-hidden="true">→</span></Link><Link className="rounded-xl border border-white/10 bg-white/[0.035] p-4 font-black text-white" href="/dashboard/education/documents">Education Documents <span aria-hidden="true">→</span></Link><Link className="rounded-xl border border-white/10 bg-white/[0.035] p-4 font-black text-white" href="/dashboard/education/guidance-counselor">Discuss with Guidance Counselor <span aria-hidden="true">→</span></Link></section>
    </div>
  );
}
