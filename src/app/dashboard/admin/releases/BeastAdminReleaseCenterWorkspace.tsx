    ...
    return (
      <DashboardCard accent="admin">
        <SectionHeader
          ...
          description="BeastAdmin is retrieving owner-managed validation, migration, and production deployment records."
        />
    ...
    <div className="space-y-6">
      ...
      <DashboardCard accent="admin">
        <SectionHeader
          ...
          title="Record only what the release actually included"
          description="The generated version manifest and public release notes remain useful references, but neither is treated as proof of migrations, validation, or production deployment."
          action={
