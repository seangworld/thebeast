...
import { BEAST_HUNTER_VERSION, beastHunterBuiltInPresets, beastHunterHuntTypes, beastHunterMarkets, beastHunterResultCounts, beastHunterTrackingStatuses, defaultBeastHunterCriteria, validateBeastHunterCriteria, type BeastHunterCriteria, type BeastHunterEvidenceScores, type BeastHunterRankedCandidate, type BeastHunterTrackingStatus } from "@/lib/beastHunter";
...
const scoreLabels: Record<keyof BeastHunterEvidenceScores, string> = { demand: "Demand", velocity: "Velocity", competitionGap: "Competition gap", commercialIntent: "Commercial intent", saturation: "Saturation risk", aiCommoditizationRisk: "AI risk", seangworldFit: "SEANGWORLD fit", timeToMarket: "Time to market", revenuePotential: "Revenue potential", durability: "Durability", confidence: "Confidence", actionWindow: "Action window", ownerFit: "Owner fit", verifiability: "Verifiability", aiBuildability: "AI buildability", liabilityRisk: "Liability risk" };
