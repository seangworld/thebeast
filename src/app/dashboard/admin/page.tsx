...
import { BeastAdminOwnerOverview } from "./BeastAdminOwnerOverview";
...
export default function BeastAdminDashboardPage() {
  ...
  return <BeastAdminShell title="BeastAdmin" purpose="Manage The Beast, its members, and platform controls." actions={<Link href="/dashboard/operations" className="min-h-11 rounded-xl bg-amber-200 px-4 py-3 text-sm font-bold text-slate-950">Open SEANGWORLD HQ</Link>}>
    <BeastAdminOwnerOverview />
    <details className="mt-6 rounded-2xl border border-white/10 bg-slate-900/40 p-5"><summary className="cursor-pointer text-sm font-black text-slate-300">All BeastAdmin tools</summary><div className="mt-5 grid gap-5 md:grid-cols-2">
