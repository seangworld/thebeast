...
type Job = { id: string; series_id: string; state: VideoJobState; topic: JobTopic; script?: { estimatedSeconds?: number; warnings?: string[] }; quality?: { warnings?: string[] }; last_error?: string | null; updated_at: string };
type Snapshot = {
