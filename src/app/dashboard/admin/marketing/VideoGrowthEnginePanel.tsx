...
type Job = { id: string; series_id: string; state: VideoJobState; revision?: number; created_at?: string; topic: JobTopic; script?: { estimatedSeconds?: number; warnings?: string[] }; production?: { manifest?: { checksum: string; runtimeMs: number; width: number; height: number; scenes: unknown[]; planState: string; blockers: string[]; visualPlan?: { beats?: unknown[] } }; providerState?: string; externalActionPerformed?: boolean; renderAuthorizationRequired?: boolean; syncVerificationRequired?: boolean; technicalRetry?: { authorizedByOwner?: boolean; maximumAttempts?: number; attemptsConsumed?: number }; estimatedCredits?: { estimatedTotal: number; basis: string } }; quality?: { warnings?: string[]; renderReady?: boolean; ownerQualityReview?: string; ownerWorkflowDecision?: string; ownerApprovalSource?: string; ownerQualityGrade?: string; technicalResult?: string; creativeResult?: string; voiceReview?: string; pacingReview?: string; visualFramingReview?: string; motionTreatmentReview?: string; qualityScore?: number; runtimeSeconds?: number; visualBeatCount?: number; syncVerificationRequired?: boolean; syncMethod?: string; autoApprovalBlockers?: string[]; remediationRenderUsed?: boolean; narrationNormalizationRenderUsed?: boolean; controlTokenRemediationRenderUsed?: boolean }; provenance?: { generatedBy?: string; generationMode?: string; generatedAt?: string; waitingForOwnerApproval?: boolean; candidateIndex?: number; candidateCount?: number; visualTemplate?: string; candidateLabel?: string; revisionLabel?: string; acceptanceTest?: number; activeCandidate?: boolean; superseded?: boolean; visualPresentationRevision?: boolean; revision6SyncRuntime?: boolean; syncVerificationRequired?: boolean; syncMethod?: string; technicalRetryAuthorized?: boolean; cadencePlan?: { plannedFor?: string } }; latestAttempt?: { attemptNumber?: number; status?: string; errorCategory?: string | null; providerRequestId?: string | null; providerHttpStatus?: number | null; providerErrorCode?: string | null; providerErrorMessage?: string | null; providerValidationPath?: string | null; createdAt?: string; completedAt?: string | null } | null; technicalRecovery?: { available?: boolean; attemptNumber?: number; providerHttpStatus?: number | null }; last_error?: string | null; updated_at: string };
type Snapshot = {
