...
export function HealthAdvisorWorkspace({ initialVeteransMode = false }: { initialVeteransMode?: boolean } = {}) {
  ...
  const [veteransMode, setVeteransMode] = useState(initialVeteransMode);
