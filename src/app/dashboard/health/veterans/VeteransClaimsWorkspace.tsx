...
export function VeteransClaimsWorkspace() {
  ...
  return <div className="space-y-5">
    ...
    <div className="flex flex-wrap gap-3">
      <Link target="_blank" rel="noopener noreferrer" href="/dashboard/health/ai-advisor" className="beast-button-secondary">Ask Health Advisor — select Veterans assistance</Link>
