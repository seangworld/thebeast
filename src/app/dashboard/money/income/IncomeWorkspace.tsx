  ...
  return (
    <div className="space-y-6 pb-12" data-income-workspace="true">
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        ...
        <section className="beast-panel p-5" id="funding-rules"><h2 className="money-section-title">Funding Rules &amp; Paycheck Strategy</h2><p className="mt-2 text-sm leading-6 text-slate-300">Assign every bill and debt minimum to an upcoming paycheck, see what remains, and review the suggested extra-debt move.</p><Link className="beast-button-secondary mt-4 inline-flex" href="/dashboard/money/cashflow#paycheck-strategy">Open Paycheck Strategy</Link></section>
