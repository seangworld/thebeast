    ...
    <div className="min-h-screen bg-[#1a1f2e] text-[#c7cfdb]">
      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-12">
        <div className="mb-12 rounded-lg border border-cyan-300/25 bg-[#0f1419] p-6">
          <div className="mb-4">
            <h2 className="text-2xl font-bold">BeastEducation v1.7.1 · BeastOS v3.0.1</h2>
            <p className="mt-1 text-sm text-[#7f8da3]">August 29, 2026</p>
          </div>
          <h3 className="font-semibold text-[#c7cfdb]">AI Tutor availability and Product truth</h3>
