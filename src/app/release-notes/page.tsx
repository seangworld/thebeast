    ...
    <div className="min-h-screen bg-[#1a1f2e] text-[#c7cfdb]">
      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-12">
        <div className="mb-12 rounded-lg border border-cyan-300/25 bg-[#0f1419] p-6">
          ...
          <h3 className="font-semibold text-[#c7cfdb]">AI Tutor availability and clearer CEO Mode evidence</h3>
          <ul className="mt-3 space-y-2 pl-4 text-sm text-[#a5b4c7]">
            ...
            <li><span className="text-cyan-300">✓</span> Removed the outdated Education workspace message that described Tutor as on hold and added a direct Start tutoring action.</li>
            <li><span className="text-cyan-300">✓</span> Grouped related roadmap-indexing diagnostics into one understandable CEO Mode item and connected advisory opportunities to the governed Strategy Proposal feed.</li>
            <li><span className="text-cyan-300">✓</span> Clarified that hosted BeastAdmin verifies repository/deployment evidence but cannot observe a local worktree.</li>
          </ul>
        </div>
        ...
        <div className="mb-12 rounded-lg border border-[#2a3242] bg-[#0f1419] p-6">
          <div className="mb-4">
            <h2 className="text-2xl font-bold">BeastOS v3.0.0</h2>
            ...
            <div>
              ...
              <ul className="space-y-2 pl-4">
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Added an Executive
                  Health Briefing, Medication Review, Appointment Preparation,
                  provider questions, document understanding, recommendations,
                  timeline summaries, and preparation-outcome learning.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Connected explicit
                  owner decisions to Execution History, recommendation
                  lifecycle, confidence, results, outcomes, and immutable audit
                  records.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Preserved medical
                  safety: Health Advisor never diagnoses, changes medication,
                  interprets clinical significance, or replaces clinicians.
                </li>
              </ul>
            </div>
          </div>
        ...
        {/* BeastOS v3.0.0-beta1 */}
        <div className="mb-12 rounded-lg border border-[#2a3242] bg-[#0f1419] p-6">
          <div className="mb-4">
            <h2 className="text-2xl font-bold">BeastOS v3.0.0-beta1</h2>
            <p className="mt-1 text-sm text-[#7f8da3]">
              July 28, 2026 · Release candidate
            </p>
          </div>
          <div className="space-y-4 text-sm">
            <div>
              <h3 className="font-semibold text-[#c7cfdb]">
                BeastHealth Owner Beta
              </h3>
              <ul className="space-y-2 pl-4">
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Added protected
                  health overview, profile, condition, medication, procedure,
                  vital, document, lifestyle, family-history, provider, and
                  timeline workspaces.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Added owner-entered,
                  source-aware records with RLS, honest empty states, and no
                  placeholder health activity.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Kept Health Advisor,
                  execution, recommendations, confidence, and outcome learning
                  inactive pending explicit safety and privacy approval.
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="mb-12 rounded-lg border border-[#2a3242] bg-[#0f1419] p-6">
          <div className="mb-4">
            <h2 className="text-2xl font-bold">BeastOS v2.3.1</h2>
            <p className="mt-1 text-sm text-[#7f8da3]">
              July 28, 2026 · Release candidate
            </p>
          </div>
          ...
          <div className="space-y-4 text-sm">
            <div>
              ...
              <ul className="space-y-2 pl-4">
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Added a Learning
                  Briefing, diagnostics evidence, goal and learning-path
                  planning, career guidance, priorities, notifications, and
                  outcome learning.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Connected explicit
                  recommendation decisions to Execution History, lifecycle,
                  confidence, approvals, results, outcomes, and immutable audit
                  records.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Preserved the
                  professional boundary: Guidance Counselor plans and
                  prioritizes; the existing Tutor teaches and returns learning
                  evidence.
                </li>
              </ul>
            </div>
        ...
        <div className="mb-12 rounded-lg border border-[#2a3242] bg-[#0f1419] p-6">
          <div className="mb-4">
            <h2 className="text-2xl font-bold">BeastOS v2.3.0-alpha1</h2>
            <p className="mt-1 text-sm text-[#7f8da3]">
              July 28, 2026 · Release candidate
            </p>
          </div>
          ...
          <div className="space-y-4 text-sm">
            <div>
              ...
              <ul className="space-y-2 pl-4">
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Connected Google
                  Analytics 4 and Google Search Console through secure
                  server-only adapters.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Added live owner
                  reporting, provider health and freshness, and deterministic
                  evidence-based recommendations.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Missing or
                  unavailable providers degrade safely without fake analytics.
                  AdSense remains excluded.
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="mb-12 rounded-lg border border-[#2a3242] bg-[#0f1419] p-6">
          <div className="mb-4">
            <h2 className="text-2xl font-bold">BeastOS v2.2.0</h2>
            <p className="mt-1 text-sm text-[#7f8da3]">July 28, 2026</p>
          </div>

          <div className="space-y-4 text-sm">
            <div>
              <h3 className="font-semibold text-[#c7cfdb]">
                BeastAdmin Canonical Routes
              </h3>
              <ul className="space-y-2 pl-4">
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Standardized Platform
                  Health and Prompt Library on their permanent long-form
                  BeastAdmin routes.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Existing bookmarks
                  continue to work through permanent compatibility redirects.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Authentication,
                  authorization, APIs, owner behavior, and persisted data are
                  unchanged.
                </li>
              </ul>
            </div>
        ...
        <div className="mb-12 rounded-lg border border-[#2a3242] bg-[#0f1419] p-6">
          <div className="mb-4">
            <h2 className="text-2xl font-bold">BeastOS v2.1.1</h2>
            <p className="mt-1 text-sm text-[#7f8da3]">July 20, 2026</p>
          </div>

          <div className="space-y-4 text-sm">
            <div>
              <h3 className="font-semibold text-[#c7cfdb]">
                Critical Horizontal Overflow Hotfix
              </h3>
              <ul className="space-y-2 pl-4">
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Fixed site-wide
                  horizontal overflow and off-screen content without globally
                  clipping content.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Improved responsive
                  reflow for the shared shell, navigation labels, Admin member
                  data, and Learning lesson controls.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Kept wide financial
                  datasets inside labeled, keyboard-focusable component scroll
                  regions.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> No calculations,
                  learning progression, persistence, RLS, roles, navigation
                  hierarchy, migrations, or BeastOS v2.2 roadmap features are
                  included.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 pl-4">
                ...
                <li className="text-[#a5b4c7]">
                  ...
                  profile setup, diagnostic placement, skill-gap detection, and
                  Pre-Algebra path generation.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Added tutor turns
                  for response evaluation, hints without answer reveal,
                  alternate explanations, mastery checks, remediation, and
                  lesson resume state.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Progress reporting
                  now distinguishes completion from mastery. Breaking changes:
        ...
        <div className="mb-12 rounded-lg border border-[#2a3242] bg-[#0f1419] p-6">
          ...
          <div className="space-y-4 text-sm">
            <div>
              <h3 className="font-semibold text-[#c7cfdb]">
                Curriculum and Content Discipline
              </h3>
              <ul className="space-y-2 pl-4">
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Added content
                  status labels for courses, lessons, study guides, and
                  recommendations.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Added review
                  requirements for accuracy, age appropriateness,
                  accessibility, and safety.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Starter paths may
                  claim only implemented source-backed content; public copy
                  must avoid full curriculum, compliance, teacher-portal, or
                  integration claims.
                </li>
                <li className="text-[#a5b4c7]">
                  <span className="text-blue-400">✓</span> Third-party
                  learning-site direction remains planning context only.
                  Breaking changes: none. Migration notes: no database
                  migration required.
                </li>
              </ul>
            </div>
