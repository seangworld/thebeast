...
export const professionalConfigs: Record<ProfessionalId, ProfessionalConfig> = {
  ...
  "beasteducation.guidance-counselor": {
    ...
    allowedTools: [...sharedTools, "read_education_profile", "inspect_education_plan", "inspect_career_plan", "create_school_proposal", "create_certification_proposal"],
    dataDomains: ["education", "career", "military", "employment", "goals", "documents"], researchDomains: ["ed.gov", "bls.gov", "opm.gov", "usajobs.gov", "va.gov"],
    ...
    workspaces: [{ label: "Guidance Counselor", href: "/dashboard/education/guidance-counselor", topics: ["general"] }, { label: "Education Planning", href: "/dashboard/education/education-planning", topics: ["education plan", "milestone", "school"] }, { label: "Career Planning", href: "/dashboard/education/career-planning", topics: ["career", "employment"] }, { label: "Certifications", href: "/dashboard/education/certifications", topics: ["certification"] }],
  },
