...
export const learningSpecialists: LearningSpecialist[] = [
  ...
  { id: "mentor", role: "Guidance Counselor", description: "Owns the lifelong education relationship, profile, discovery, and adaptive roadmap.", available: true },
  { id: "career-mentor", role: "Career Path Specialist", description: "Supplies career-specific evidence to the Guidance Counselor.", available: false },
