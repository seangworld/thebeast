...
> = {
  Career: {
    ...
    estimatedTimeline: "3-6 month planning placeholder",
    questionsToConsider: [
  ...
  "College path": {
    ...
    estimatedTimeline: "Semester-by-semester planning placeholder",
    questionsToConsider: [
  ...
  Certification: {
    ...
    estimatedTimeline: "6-10 week prep placeholder",
    questionsToConsider: [
  ...
  Trade: {
    ...
    estimatedTimeline: "3-12 month foundation placeholder",
    questionsToConsider: [
  ...
  Promotion: {
    ...
    estimatedTimeline: "1-2 review cycles placeholder",
    questionsToConsider: [
  ...
  "Skill goal": {
    ...
    estimatedTimeline: "4-8 week starter placeholder",
    questionsToConsider: [
...
function cleanGoal(value: string) {
  ...
  return trimmed.length > 0 ? trimmed : "Future goal";
}
...
export function buildGuidanceCounselorRoadmap(
  ...
  return {
    ...
    previewLabel: "Early planning preview",
  };
}
