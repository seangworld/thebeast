...
export const aiSpecialistRegistry: AISpecialistContract[] = [
  ...
  specialist({
    ...
    description: "Learns the user's story and continuously adapts lifelong education, career, school, certification, book, and external-resource roadmaps.",
    supportedSubjects: ["All"],
    supportedGoals: ["education profile", "school path", "college path", "career path", "certification path", "personal growth"],
    supportedOutputTypes: ["career roadmap", "plan"],
    requiredContext: ["profile", "goals", "career", "strengths", "weakAreas", "progress"],
  }),
  specialist({
    id: "career-mentor",
    name: "Career Path Specialist",
    description: "Supports the primary Guidance Counselor with career-specific evidence and options.",
