...
export const mockLearningPlan: LearningPlan = {
  ...
  summary:
    "Placeholder plan structure for certification study, review cadence, and future tutor-guided sessions.",
...
export const mockLearningAchievements: LearningAchievement[] = [
  {
    ...
    learnerId: "current",
    title: "7-day streak",
    detail: "Daily study rhythm placeholder",
    earned: true,
  },
  {
    id: "completed-course",
