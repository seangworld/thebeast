...
> = {
  ...
  "career-planning": {
    ...
    description: "Compare careers that may fit you and learn what each one would require.",
  ...
  schools: {
    ...
    description: "Compare schools and programs by what they offer, what they cost, what they require, and how well they fit you.",
  ...
  certifications: {
    ...
    eyebrow: "Certificate planning",
    description: "See which certificates may help, what they require, and which ones fit your goal.",
