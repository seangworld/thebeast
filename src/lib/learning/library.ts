...
export const learningLibraryMaterials: LearningLibraryMaterial[] = [
  {
    ...
    author: "CompTIA-style placeholder",
    source: "Uploaded reference placeholder",
  ...
  },
  {
    ...
    source: "Manual note placeholder",
    difficulty: "Beginner",
  ...
  },
  {
    ...
    source: "External resource placeholder",
    difficulty: "Beginner",
  ...
  },
  {
    ...
    author: "BeastLearning sample",
    source: "Practice exam placeholder",
    difficulty: "Intermediate",
