...
export const defaultAgentActionTools = [
  ...
  { id: "open-money-dashboard", title: "Open financial dashboard", description: "Open the BeastMoney analytical dashboard.", kind: "navigate", permission: { resource: "beastmoney.workspace", action: "open" }, requiredData: [], confirmation: "none", specialistAvailability: [moneyCoach], target: "/dashboard/money#money-dashboard" },
  ...
  { id: "open-forecast", title: "Open Forecast", description: "Open BeastMoney forecasting in the financial dashboard.", kind: "navigate", permission: { resource: "beastmoney.forecast", action: "read" }, requiredData: [], confirmation: "none", specialistAvailability: [moneyCoach], target: "/dashboard/money#money-dashboard" },
  ...
  { id: "open-income-pots", title: "Open Income Pots", description: "Open income planning in the BeastMoney cash-flow workspace.", kind: "navigate", permission: { resource: "beastmoney.cashflow", action: "read" }, requiredData: [], confirmation: "none", specialistAvailability: [moneyCoach], target: "/dashboard/money/cashflow#income-planning" },
