...
export const defaultAgentActionTools = [
  ...
  { id: "open-financial-health-score", title: "Open Financial Health Score", description: "Open the transparent BeastMoney financial-wellness calculation.", kind: "navigate", permission: { resource: "beastmoney.workspace", action: "open" }, requiredData: [], confirmation: "none", specialistAvailability: [moneyCoach], target: "/dashboard/money/financial-health" },
  { id: "open-money-observations", title: "Review important alerts", description: "Open evidence-backed BeastMoney alerts on the Dashboard.", kind: "navigate", permission: { resource: "beastmoney.workspace", action: "open" }, requiredData: [], confirmation: "none", specialistAvailability: [moneyCoach], target: "/dashboard/money/dashboard#important-alerts" },
  ...
  { id: "open-bills", title: "Open Bills", description: "Open the owner-scoped Bills workspace.", kind: "navigate", permission: { resource: "beastmoney.bills", action: "read" }, requiredData: [], confirmation: "none", specialistAvailability: [moneyCoach], target: "/dashboard/money/bills" },
  ...
  { id: "open-payoff-plan", title: "Open Payoff Plan", description: "Open the owner-scoped debt payoff planning workspace.", kind: "navigate", permission: { resource: "beastmoney.debts", action: "read" }, requiredData: [], confirmation: "none", specialistAvailability: [moneyCoach], target: "/dashboard/money/payoff-plan" },
  ...
  { id: "open-funding-sources", title: "Open Payment Configuration", description: "Open payment and funding accounts plus obligation payment workflows in BeastMoney Cash Flow.", kind: "navigate", permission: { resource: "beastmoney.cashflow", action: "read" }, requiredData: [], confirmation: "none", specialistAvailability: [moneyCoach], target: "/dashboard/money/cashflow#funding-sources" },
