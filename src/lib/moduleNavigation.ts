...
export const beastLearningNavigation: ModuleNavSection = {
  ...
  children: [
    ...
    { label: "Paths", href: "/dashboard/education#paths" },
    { label: "Roadmap", href: "/dashboard/education#roadmap" },
    { label: "Goals", href: "/dashboard/goals?module=education" },
    { label: "Documents", href: "/dashboard/uploads?module=education" },
...
const plannedModuleNavigation: Record<string, ModuleNavSection> = {
  health: {
    ...
    children: [
      ...
      { label: "Vitals", href: "/dashboard/health/vitals", group: "Health records" },
      { label: "Documents", href: "/dashboard/health/documents", group: "Health records" },
      { label: "Provider Directory", href: "/dashboard/health/provider-directory", group: "Health records" },
      { label: "Appointments", href: "/dashboard/health/appointments", group: "Health records" },
      { label: "Health Timeline", href: "/dashboard/health/timeline", group: "Health records" },
    ],
  },
