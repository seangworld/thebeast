...
export const healthDiscoveryTopics: HealthDiscoveryTopic[] = [
  ...
  },
  {
    ...
    prompt: "Are there any health conditions or ongoing concerns you want included in your health story? Share only what you know.",
    href: "/dashboard/health/ai-advisor",
    source: "beasthealth",
  },
  {
    ...
    prompt: "What medicines do you take now, if any? You can use the name from a label or prescription.",
    href: "/dashboard/health/ai-advisor",
    source: "beasthealth",
  },
  {
    ...
    category: "health-profile",
    recordKind: "profile",
    prompt: "What allergies or sensitivities, if any, would you like Beast to remember? Share only what you know.",
    href: "/dashboard/health/ai-advisor",
    source: "beasthealth",
  },
  {
  ...
  },
  {
    ...
    category: "care-team",
    recordKind: "provider",
    prompt: "Which specialists or medical offices should Beast remember for future appointments?",
    href: "/dashboard/health/ai-advisor",
    source: "beasthealth",
  },
  {
    ...
    category: "health-profile",
    recordKind: "profile",
    prompt: "What insurance information would help you organize appointments? Do not share member or policy numbers here.",
    href: "/dashboard/health/ai-advisor",
    source: "beasthealth",
  },
  {
  ...
  },
  {
    ...
    category: "health-profile",
    recordKind: "profile",
    prompt: "What health goal would you like to organize or discuss with a doctor?",
    href: "/dashboard/health/ai-advisor",
    source: "beasthealth",
  },
  {
