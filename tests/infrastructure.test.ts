...
test("learning activities have a dedicated runner and next-activity unlock logic", () => {
  ...
  assert.doesNotMatch(lessonEngine, /Save for Mentor/);
  assert.doesNotMatch(lessonEngine, /Save this for my Mentor/);
...
test("BeastLearning member experience hides workflow mechanics behind Mentor and Tutor language", () => {
  ...
  assert.doesNotMatch(memberExperienceSource, /Your Mentor's Next Step/);
